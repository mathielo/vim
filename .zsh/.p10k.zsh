# Generated by Powerlevel10k configuration wizard on 2025-10-15 at 14:01 CEST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#6B4E00
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=#FD9D5D
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=#FD9D5D
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#6B4E00
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=#7A5200
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#5C3B00
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=#FCCC73
  # typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=#F77F00
  # typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=#FB8500
  # typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=#E85D04
  # typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=#A65E00
  ...
  function my_git_formatter() {
    ...
    local       meta='%94F' # dark yellow-brown foreground
    local      clean='%94F' # dark yellow-brown foreground
    local   modified='%130F' # brown/orange foreground
    local  untracked='%94F' # dark yellow-brown foreground
    local conflicted='%160F' # strong red foreground
